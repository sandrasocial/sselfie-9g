...
describe("analytics event contract", () => {
  it("includes guided activation and onboarding lifecycle events", () => {
    ...
    expect(ALLOWED_ANALYTICS_EVENTS).toContain("work_with_me_checkout_success")
    ...
    expect(ALLOWED_ANALYTICS_EVENTS).toContain("suite_post_project_list_opened")
    expect(ALLOWED_ANALYTICS_EVENTS).toContain("suite_post_project_resumed")
    expect(ALLOWED_ANALYTICS_EVENTS).toContain("suite_post_project_archived")
  ...
  it("accepts known event names", () => {
    ...
    expect(isAllowedAnalyticsEventName("work_with_me_checkout_success")).toBe(true)
