...
const assets = [
  "public/images/starter-kit/starter-kit-product-mockup-v2.webp",
  "public/images/starter-kit/preset-collection-vertical-v2.webp",
  "public/images/one-selfie/bundle-products-mockup-v1.webp",
  "public/images/one-selfie/og-bundle-v1.webp",
] as const

describe("public product mockups", () => {
  it("keeps the Starter Kit and campaign on separate truthful visuals", () => {
    expect(starterPage).toContain("/images/starter-kit/starter-kit-product-mockup-v2.webp")
    expect(starterPage).toContain("/images/starter-kit/preset-collection-vertical-v2.webp")
    expect(starterPage).not.toContain("16 Lightroom Presets")
    expect(bundlePage).toContain("/images/one-selfie/bundle-products-mockup-v1.webp")
    expect(bundleRoute).toContain("/images/one-selfie/og-bundle-v1.webp")
  })
