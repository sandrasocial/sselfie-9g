...
describe("AI prompts free page locked Vault previews", () => {
  ...
  it("keeps the free prompt pack and paid Vault in separate lanes", () => {
    ...
    expect(vaultLandingContents).toContain("THE FULL LIBRARY PREVIEW")
    expect(vaultLandingContents).toContain("Build a visual world you can repeat.")
    expect(vaultLandingContents).toContain("The free preview is the first image.")
    expect(vaultLandingContents).toContain("The Vault is the full direction")
