...
describe("visibility suite entitlements and routing", () => {
  ...
  it("visibility plan generator route and page exist", () => {
    ...
    expect(route).toContain("pricingSignal")
    expect(page).toContain("Visibility Plan")
    expect(page).toContain("What your answers mean.")
    expect(page).toContain("Apply For Private Sprint")
    expect(client).toContain("Audit My Answers")
    expect(client).toContain("Market Fit")
