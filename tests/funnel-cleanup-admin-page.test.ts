...
describe("funnel cleanup admin page", () => {
  it("exposes the cleanup inventory as a read-only admin review surface", () => {
    ...
    expect(page).toContain("Last 90 Days")
    expect(page).toContain("Cleanup Score")
    expect(page).toContain("revenue90dCents")
    expect(page).toContain("checkoutCompletions90d")
    expect(page).toContain("scoreLabel")
