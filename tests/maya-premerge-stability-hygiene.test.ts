...
describe("maya premerge stability hygiene", () => {
  it("removes workbook and photoshoot quick prompts from Maya home", () => {
  ...
  it("removes workbook capability cards and retired workbook messaging from Maya chat UI", () => {
    ...
    expect(accountScreen).not.toContain("landing page, calendar, or workbook")
