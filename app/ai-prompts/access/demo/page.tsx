...
const WORKFLOW_PROMPTS: PromptCard[] = [
  {
    ...
    title: "Selfie Audit",
    whenToUse:
      "You know something is off but you can't identify what. Use this before you try any of the visual prompts.",
  ...
  },
  {
    ...
    whenToUse:
      "You have a photo but don't know what to write. Use this to turn a selfie into an Instagram caption.",
      ...
      <section className="ap-hero">
        ...
        <div className="ap-hero-content">
          ...
          <p className="ap-hero-sub">
            ...
            brand-ready visuals you can test before choosing your next step.
          </p>
