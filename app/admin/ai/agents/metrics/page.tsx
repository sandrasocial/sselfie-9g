...
import MetricsDashboard from "@/components/admin/ai/MetricsDashboard"
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-stone-600 mt-2 font-light">Live performance metrics for all agents</p>
          </div>
