...
import PipelineHistoryList from "@/components/admin/ai/PipelineHistoryList"
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-stone-600 mt-2 font-light">View past pipeline executions</p>
          </div>
