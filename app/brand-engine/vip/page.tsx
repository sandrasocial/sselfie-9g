...
function SectionLabel({ children }: { children: ReactNode }) {
  return (
    <p
      className={`${inter.className} text-[11px] uppercase tracking-[0.5em] text-[#666666]`}
...
function SectionHeading({ children }: { children: ReactNode }) {
  return (
    <h2
      className={`${cormorant.className} text-[42px] sm:text-[54px] leading-[1.05] uppercase text-[#0a0a0a]`}
...
export default function BrandEngineVipPage() {
  return (
    <main className={`${inter.className} min-h-screen bg-[#ffffff] text-[#0a0a0a]`}>
      <div className="w-full px-12 lg:px-16 py-12">
        <header className="flex items-center justify-between">
          <Link href="/" className={`${cormorant.className} text-[26px] uppercase tracking-[0.12em]`} style={{ fontWeight: 300 }}>
            SSELFIE
          </Link>
          <Link href="/brand-engine" className="text-[11px] uppercase tracking-[0.35em] text-[#666666]">
            Cohort
          </Link>
        </header>
      </div>
      ...
      <section className="px-12 lg:px-16 pb-16">
        <div className="max-w-[820px] lg:ml-[8vw]">
          ...
          <h1
            className={`${cormorant.className} mt-4 text-[60px] sm:text-[88px] lg:text-[118px] leading-[0.9] uppercase text-[#0a0a0a]`}
            style={{ fontWeight: 300 }}
          >
            BRAND ENGINE VIP
          </h1>
          <p className="mt-8 text-[18px] leading-[1.8] text-[#0a0a0a]">Just you and Sandra. Your entire brand built together.</p>
          <div className="mt-10">
            <Link
              href={vipApplyHref}
              className="inline-flex bg-[#0a0a0a] text-[#ffffff] px-8 py-4 text-[12px] uppercase tracking-[0.35em] hover:opacity-90 transition-opacity"
            >
              Apply for VIP
            </Link>
          </div>
      ...
      <section className="px-12 lg:px-16 py-16 bg-[#f5f5f5]">
        <div className="max-w-[760px] lg:ml-[14vw]">
          <SectionLabel>What this is</SectionLabel>
          <SectionHeading>THIS IS NOT A COURSE</SectionHeading>
          <div className="mt-8 text-[16px] sm:text-[18px] leading-[1.8] text-[#0a0a0a] space-y-4">
        ...
        <div className="max-w-[980px] lg:ml-[6vw]">
          ...
          <div className="mt-10 border-t border-[#e5e5e5]">
            {[
              ...
              <div key={item.week} className="grid grid-cols-1 md:grid-cols-[170px_1fr] gap-4 md:gap-8 py-8 border-b border-[#e5e5e5]">
                <p className="text-[11px] uppercase tracking-[0.35em] text-[#666666]" style={{ fontWeight: 500 }}>
                  {item.week}
                </p>
                <div>
                  <h3 className={`${cormorant.className} text-[32px] sm:text-[38px] leading-[1.1] uppercase`} style={{ fontWeight: 300 }}>
                    {item.title}
                  </h3>
                  <p className="mt-3 text-[16px] leading-[1.8] text-[#0a0a0a]">{item.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="px-12 lg:px-16 py-20">
        <div className="max-w-[760px] lg:ml-[7vw]">
          ...
          <p className="mt-3 text-[20px] leading-[1.8] text-[#666666]">Or 3 x €1,749</p>
          <p className="mt-8 text-[16px] sm:text-[18px] leading-[1.8] text-[#0a0a0a]">
      ...
      <section className="px-12 lg:px-16 py-24">
        <div className="max-w-[760px] lg:ml-[8vw]">
          ...
          <div className="mt-6">
            <Link href={cohortApplyHref} className="text-[12px] uppercase tracking-[0.25em] text-[#666666] hover:text-[#0a0a0a]">
