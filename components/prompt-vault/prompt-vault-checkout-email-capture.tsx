...
export function PromptVaultCheckoutEmailCapture({
  ...
  copy = "Add your email before checkout so your access link and receipt go to the right place. The Vault helps you choose a visual world and stop starting from scratch every time you want a better image.",
  ...
  productMeta = "Repeatable AI brand shoot worlds",
