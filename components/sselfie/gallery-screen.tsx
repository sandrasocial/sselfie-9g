        ...
        <div className="bg-stone-100/40 rounded-3xl p-6 sm:p-8 border border-stone-200/40">
          <div className="flex items-center gap-6 mb-6">
            <button
              ...
              className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-stone-300/60 flex-shrink-0 group"
            >
            ...
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl font-light tracking-wide text-stone-950 mb-2">{displayName}</h2>
              <p className="text-xs font-light text-stone-600">Your curated AI photo collection</p>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-6 mb-6 pb-6 border-b border-stone-200/40">
            <div className="text-center">
              <div className="text-xl sm:text-2xl font-light text-stone-950 mb-1">{favoritedImages.length}</div>
              <div className="text-xs tracking-[0.1em] uppercase font-light text-stone-500">Favorited Images</div>
            </div>
          </div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 text-xs tracking-[0.15em] uppercase font-light border border-stone-200/40 rounded-full transition-all duration-200 whitespace-nowrap flex-shrink-0 ${
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          <button
            ...
            className={`group bg-white/50 backdrop-blur-2xl border rounded-[1.5rem] p-4 text-center shadow-xl shadow-stone-900/10 hover:shadow-2xl hover:shadow-stone-900/20 hover:scale-105 transition-all duration-300 ${
                ...
                <div className="absolute inset-0 bg-stone-950/0 group-hover:bg-stone-950/40 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 rounded-2xl">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="p-3 bg-white/90 backdrop-blur-xl rounded-full hover:bg-white transition-colors shadow-lg border border-white text-stone-950"
                    >
