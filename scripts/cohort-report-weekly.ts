 ...
 * - signups
 * - uploaded selfies (selfie_uploads OR user_avatar_images)
 * - planner started (feed_posts)
 ...
 * - day-1 activity proxy (feed_posts/ai_images/user_models/generation_trackers in first 24h)
 *
