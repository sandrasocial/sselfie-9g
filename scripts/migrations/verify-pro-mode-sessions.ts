/**
 * Verify pro_mode_sessions table was created successfully
 */
...
async function verifyTable() {
  ...
  console.log('[VERIFY] Checking pro_mode_sessions table...')
  ...
  try {
    ...
    const tableExists = await sql`
      SELECT EXISTS (
        ...
        AND table_name = 'pro_mode_sessions'
      )
    `
    ...
    const indexes = await sql`
      ...
      AND tablename = 'pro_mode_sessions'
    `
