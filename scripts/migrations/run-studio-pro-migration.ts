/**
 * Run Studio Pro Database Migration
 * 
...
async function runMigration() {
  ...
  console.log('[MIGRATION] Starting Studio Pro tables migration...')

  try {
    // Read the SQL file
    const sqlPath = path.join(process.cwd(), 'scripts/migrations/12-studio-pro-tables.sql')
    ...
    console.log('[MIGRATION] ✅ Studio Pro tables migration completed successfully')
  } catch (error) {
