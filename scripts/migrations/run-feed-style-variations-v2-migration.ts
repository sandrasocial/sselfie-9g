/**
 * Migration: Add Feed Planner V2 style variations + per-feed selection
 */
...
async function runMigration() {
  console.log("[FEED-PLANNER-V2] ==================== RUNNING STYLE VARIATIONS MIGRATION ====================")

  const migrationPath = join(process.cwd(), "scripts", "migrations", "2026-01-20-add-feed-style-variations-v2.sql")
