...
import { getOverlayStyleGuide, isTextOverlayLayerEnabled } from "@/lib/app-v3/text-overlay"
...
${ctx.format !== "photo" && ctx.format !== "photoshoot" && ctx.format !== "video" && isTextOverlayLayerEnabled() ? `\n${getOverlayStyleGuide()}\n` : ""}
