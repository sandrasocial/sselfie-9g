...
const FORMAT_GUIDANCE: Record<OutputFormat, string> = {
  ...
  "story-sequence":
    "The user wants a full multi-slide STORY SEQUENCE: a vertical 9:16 set of 3 to 7 story frames in one cohesive world. Plan it exactly like a carousel (brief.graphic.creativePlan with mode 'carousel' and multiple outputs), but write quick, emotional beats (hook, tension, shift, desire, soft CTA) with short felt copy, not a teaching deck. Each slide is a real-image moment of her with baked editorial text.",
  video:
