...
export function generateSelfieGuidePaidDeliveryEmail(params: SelfieGuidePaidDeliveryParams): {
  ...
  const guidePanel = renderStonePanel(
    `<p style="margin:0 0 10px;font-size:15px;line-height:1.75;color:#f0ede8;">Inside, I walk you through the phone photo basics and the content step that makes the photo useful.</p>
     <p style="margin:0;font-size:15px;line-height:1.75;color:#a8a49c;">Your first win is simple: one photo you'd actually post, one caption idea, and one clear job for that post.</p>`,
    "What You'll Open",
  )

  const passwordBlock = passwordSetupLink
    ? renderStonePanel(
        `<p style="margin:0 0 12px;font-size:15px;line-height:1.75;color:#f0ede8;">I also set up your SSELFIE account so you can come back anytime. Set your password once and you're in.</p>
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">It's here and ready for you. This is the first step: take one phone photo and turn it into a post that actually says something.</p>
    ${guidePanel}
    ...
    ${passwordBlock}
    ${renderStonePanel(
      `<p style="margin:0 0 12px;font-size:15px;line-height:1.75;color:#f0ede8;">Whenever you're ready for the next step, the Starter Kit gives you the presets, a quick-start workflow, and a simple 7-day content starter.</p>
...
It's here and ready for you. This is the first step: take one phone photo and turn it into a post that actually says something.
...
`
      : ""
  }Whenever you're ready for the next step, the Starter Kit is here: https://www.sselfie.ai/starter-kit
