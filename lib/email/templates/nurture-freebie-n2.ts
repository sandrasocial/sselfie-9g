...
export function generateNurtureFreebieN2Email({
  firstName,
  recipientEmail,
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border:1px solid #e7e5e4;">
          <tr>
            <td style="padding:28px;">
              ...
              <p style="margin:0;font-size:16px;line-height:1.7;">Not because I suddenly had more hours. But because I stopped using my brain for the stuff AI could do better and faster.</p>
            </td>
          </tr>
        </table>
      </td>
