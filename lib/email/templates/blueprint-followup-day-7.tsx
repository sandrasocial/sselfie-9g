        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 0 30px 30px;">
              ...
              <p style="margin: 0 0 16px; color: #292524; font-size: 15px; font-weight: 300; line-height: 1.7;">
                She completed the blueprint, got her caption templates, and decided to try one photoshoot. Just one. $49.
              </p>
              ...
              <p style="margin: 0 0 24px; color: #292524; font-size: 15px; font-weight: 300; line-height: 1.7;">
                Ready to start showing up? Join SSELFIE Studio for $97/month and get unlimited photos, feed planning, and new templates every month.
              </p>
