...
export function generateBlueprintFollowupDay7Email(params: BlueprintFollowupDay7Params): {
  ...
  const bodyHtml = `
    ...
    ${renderStonePanel(
      `<p style="margin:0 0 8px;font-size:15px;line-height:1.75;color:#f0ede8;">What SUITE members get:</p>
    ...
    <div style="margin:26px 0 10px;">${renderStoneButton("Explore the SUITE", studioUrl)}</div>
...
The SUITE gives you the AI that makes showing up feel lighter every single week. Inside, you get Maya, your personal AI that generates brand photos trained on your face and aesthetic. She gets smarter the longer you use her.

What SUITE members get:
