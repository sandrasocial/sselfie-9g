export interface NurtureFreebieEmailProps {
  firstName?: string
...
export function generateNurtureFreebieN5Email({
  firstName,
  recipientEmail,
}: NurtureFreebieEmailProps): {
  html: string
  text: string
  subject: string
} {
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border:1px solid #e7e5e4;">
          <tr>
            <td style="padding:28px;">
              ...
              <p style="margin:0 0 14px;font-size:16px;line-height:1.7;">If it's not the right time - no pressure at all. The strategy Maya built is yours. Use it. Build with it. Come back when you're ready.</p>
...
If it's not the right time - no pressure at all. The strategy Maya built is yours. Use it. Build with it. Come back when you're ready.
