...
export function generateOneSelfieVisibilityOpenEmail({
  ...
  const html = renderPersonalNote({
    ...
    bodyHtml: `
      ...
      <p style="margin:0 0 18px;"><strong>The One Selfie Visibility Bundle is $97 once.</strong> You get the Starter Kit, every SSELFIE preset, the Editing Masterclass, Branded by SSELFIE, and the Prompt Vault for life. You also get 30 days inside SUITE with 200 credits. That part ends automatically. There is no subscription hiding behind it.</p>
...
The One Selfie Visibility Bundle is $97 once. You get the Starter Kit, every SSELFIE preset, the Editing Masterclass, Branded by SSELFIE, and the Prompt Vault for life. You also get 30 days inside SUITE with 200 credits. That part ends automatically. There is no subscription hiding behind it.
...
export function generateOneSelfieVisibilityInsideEmail({
  ...
  const subject = "what you can make from one selfie"
  const html = renderPersonalNote({
    title: subject,
    bodyHtml: `
      <p style="margin:0 0 18px;">Hey ${firstName},</p>
      <p style="margin:0 0 18px;">A quick look at what I actually put inside the One Selfie Bundle.</p>
      ...
      <p style="margin:0 0 18px;">$97 once. The five learning tools stay yours. The 30-day SUITE pass ends automatically. It closes ${CLOSE_LABEL}.</p>
...
A quick look at what I actually put inside the One Selfie Bundle.
...
$97 once. The five learning tools stay yours. The 30-day SUITE pass ends automatically. It closes ${CLOSE_LABEL}.
...
export function generateOneSelfieVisibilityLastCallEmail({
  ...
  const html = renderPersonalNote({
    ...
    bodyHtml: `
      <p style="margin:0 0 18px;">Hey ${firstName},</p>
      <p style="margin:0 0 18px;">Just one last note because I don't want to manufacture drama around this.</p>
      <p style="margin:0 0 18px;">The One Selfie Visibility Bundle closes today at 6:00 PM Oslo time because this is a 48-hour event. I won't quietly reset the clock tomorrow.</p>
...
Just one last note because I don't want to manufacture drama around this.

The One Selfie Visibility Bundle closes today at 6:00 PM Oslo time because this is a 48-hour event. I won't quietly reset the clock tomorrow.
