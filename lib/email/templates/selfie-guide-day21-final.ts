...
export function generateSelfieGuideDay21FinalEmail({
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">The next question is what to actually do with them.</p>
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">That's where the Masterclass fits. It takes the selfie work and turns it into captions, a content rhythm, offer clarity, and a 30-day plan you can actually follow.</p>
    <p style="margin:0 0 24px;font-size:16px;line-height:1.75;">If you want my full method in one place, this is the next step.</p>
...
The next question is what to actually do with them.

That's where the Masterclass fits. It takes the selfie work and turns it into captions, a content rhythm, offer clarity, and a 30-day plan you can actually follow.

If you want my full method in one place, this is the next step.
...
Sandra x`
  ...
  return {
    html,
    text,
    subject: "maybe you didn't need more time",
  }
}
