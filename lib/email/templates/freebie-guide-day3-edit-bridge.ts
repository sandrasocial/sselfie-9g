...
export function generateFreebieGuideDay3EditBridgeEmail({
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.8;">That is where most people get stuck after the first few days.</p>
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.8;">Still working through the guide? Keep going. I will check back in a couple of days.</p>
  ...
  return {
    ...
    html: renderStoneShell({
      ...
      bodyHtml,
      footerLead: "Keep going if you are still in the guide.",
      footerSignoff: "",
    }),
    text: `Hi ${firstName},
...
That is where most people get stuck after the first few days.
...
Still working through the guide? Keep going. I will check back in a couple of days.
