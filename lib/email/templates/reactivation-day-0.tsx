/**
 * Reactivation Day 0 Email Template
 * "It's been a while 👋"
 * 
 * Phase 1: RECONNECT - Reintroduce yourself and the mission
 * Warm, personal reconnection before pitching anything.
 */

export interface ReactivationDay0Params {
  firstName?: string
...
export function generateReactivationDay0Email(params: ReactivationDay0Params): {
  html: string
  text: string
  subject: string
} {
  ...
  const readLink = `${SITE_URL}?utm_source=coldreactivation&utm_campaign=reactivation_sequence&utm_content=day0`
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #1c1917;">
                You downloaded my selfie guide last year, and I wanted to check in.
              </p>
              ...
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #1c1917;">
                I've been building something new. Something that makes creating content that feels like <em>you</em> easier than ever.
              </p>
              
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #1c1917;">
                No pressure, no pitch — just wanted to reconnect and share what I've been up to.
              </p>

              <div style="margin: 32px 0; text-align: center;">
                <a href="${readLink}" style="display: inline-block; padding: 14px 32px; background-color: #1c1917; color: #fafaf9; text-decoration: none; font-weight: 500; font-size: 14px; letter-spacing: 0.1em; text-transform: uppercase; border-radius: 8px;">
                  Read what's new →
                </a>
              </div>

              <p style="margin: 32px 0 0; padding-top: 24px; border-top: 1px solid #e7e5e4; font-size: 15px; line-height: 1.6; color: #57534e;">
                If you're curious, take a look. If not, no worries — I'll respect that.
              </p>
...
I've been building something new. Something that makes creating content that feels like you easier than ever.

No pressure, no pitch — just wanted to reconnect and share what I've been up to.

Read what's new →: ${readLink}
