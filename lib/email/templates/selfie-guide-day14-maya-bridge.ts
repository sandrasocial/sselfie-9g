...
export function generateSelfieGuideDay14MayaBridgeEmail({
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">That's exactly what the Starter Kit is for.</p>
    ${renderStonePanel(
      `<p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:#f0ede8;">Starter Kit · $37</p>
       <p style="margin:0;font-size:15px;line-height:1.8;color:#a8a49c;">Presets, the guide, and a quick-start so you can stop fighting one photo and get a result faster. Still your real face, just the version you'd actually post.</p>`,
      "The next step",
    )}
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">It's $37. One time.</p>
...
Presets, the guide, and a quick-start so you can stop fighting one photo and get a result faster. Still your real face, just the version you'd actually post.
