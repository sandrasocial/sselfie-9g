...
export function generateAiPromptsDay0DeliveryEmail(params: AiPromptsDay0DeliveryParams): {
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">You have 17 copy-paste prompts. The Clean Editorial is the best starting point if you are not sure where to begin. Upload your selfie to ChatGPT, paste the prompt, and run it.</p>
  ...
  const html = renderStoneShell({
    ...
    eyebrow: "SSELFIE",
    subtitle: "17 prompts. Upload your selfie. Choose the look.",
    bodyHtml,
    ...heroImage,
...
You have 17 copy-paste prompts. The Clean Editorial is the best starting point if you are not sure where to begin. Upload your selfie to ChatGPT, paste the prompt, and run it.
