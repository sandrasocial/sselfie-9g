...
export function generateNurtureStrategyN4Email({
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">That is what the SUITE is trying to be. Not one more thing to manage. The thing that holds some of it with you.</p>
    <div style="margin:26px 0 22px;">${renderStoneButton("See the SUITE", trackedMembershipUrl)}</div>
...
That is what the SUITE is trying to be. Not one more thing to manage. The thing that holds some of it with you.

See the SUITE: ${trackedMembershipUrl}
