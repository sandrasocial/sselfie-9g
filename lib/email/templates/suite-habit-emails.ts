...
export function generateSuiteDay0Email({ firstName }: { firstName: string }) {
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.75;">That's it. Maya keeps you recognizable, your age, your features. The photos should still feel like you, because they start from you.</p>
    <p style="margin:0;font-size:16px;line-height:1.75;">The first time you see yourself in a real brand shoot is the moment this starts to make sense. Go make one.</p>
  `
  return {
...
That's it. Maya keeps you recognizable, your age, your features. The photos should still feel like you, because they start from you.

The first time you see yourself in a real brand shoot is the moment this starts to make sense. Go make one.
