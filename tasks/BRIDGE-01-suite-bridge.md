...
- Remaining (not in this build): backfill broadcast to past Vault/Kit buyers (Sandra-approved send via resend-broadcast skill, once trial flow is verified in prod); video tile on /join/studio when VIDEO-01 ships.
