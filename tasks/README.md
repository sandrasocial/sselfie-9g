...
|---:|---|---|---|
| 1 | `WEBHOOK-01-split-stripe-monolith.md` | Extraction started but the Stripe webhook route is still too large. | Finish the zero-behavior-change split carefully, one handler at a time. |
| 2 | `IG-AGENT-01-foundation.md` + `DM-RELIEF-01-dm-triage-system.md` | Partly built and overlapping. | Consolidate into one current DM launch checklist, then live-QA permissions and send flow. |
