...
| 5 | `CONTENT-CAROUSEL-02-new-world-generation.md` | Codex | **READY** (Sandra approved 2026-06-15). Phase 1.5: gpt-image-2 generates new-world cover/result slides (new location/outfit/lighting from Sandra's selfie, identity-locked) + baked short hero text; "tutorial worlds" presets. HARD INVARIANT: must not regress the screenshot-safe path (screenshots never reach gpt-image-2). Folds in CAROUSEL-01 review nits. Best after the in-flight content-kit work lands. |
