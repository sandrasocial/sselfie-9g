---
name: sselfie-brand-guardian
description: Must be used before any SSELFIE copy, content, campaign, email, product language, UX writing, agent prompt, offer, or public brand decision. Loads the live Constitution and relevant current contract, then checks voice, truth, audience fit, and ethical alignment.
---

# SSELFIE Brand Guardian
...
- Every number, quote, proof point, price, deadline, and availability claim is traceable.
