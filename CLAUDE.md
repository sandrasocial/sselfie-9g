...
- **CREATIVE FREEZE (2026-07-15):** Maya's prompts, prompt assembly, model routing, retrieval, and memory injection are frozen while UX work continues. UI fixes never touch creative surfaces; a failing `tests/maya-prompt-framework-freeze.test.ts` may only be resolved by a deliberate Sandra-approved prompt change. Contract: `docs/product/MAYA_CREATIVE_FREEZE_2026-07-15.md`. Regression suite spec: `tasks/MAYA-GOLDEN-01-regression-suite.md`.
