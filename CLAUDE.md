...
| CONTENT-VISUALS-01 — Content Kit: automated content visuals, Sandra approves + posts manually (NEVER auto-post) | **Phases 1+2 live 2026-06-12** — carousel kit (editorial 1080x1350 PNGs) + gpt-image-2 before/after demo engine, both on /admin/content-brief. Phase 3 = fal Kling b-roll + Seedance 2.0 teaching overlays (@byjoeym method). Spec: `tasks/CONTENT-VISUALS-01-content-kit.md` |
