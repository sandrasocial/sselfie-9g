...
| MEMBER-CHECKOUT-01 — membership checkout email capture (42 sessions/30d, 0 emails, recovery cron starving) + payment-moment fixes (Stripe product displays "Content Creator Studio" not SUITE; marketed €97 but charged $97 USD with FX fee). Live smoke test 2026-06-12: checkout WORKS mechanically. Spec: `tasks/MEMBER-CHECKOUT-01-email-capture.md` | **Approved 2026-06-12** — Phase B needs Sandra decisions (product display name + currency) |
