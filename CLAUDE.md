...
| CONTENT-VISUALS-01 — Content Kit: automated content visuals, Sandra approves + posts manually (NEVER auto-post) | **Phase 1 live 2026-06-12** — carousel kit on /admin/content-brief (generate → editorial 1080x1350 PNGs → download). Phase 2 = gpt-image-2 before/after demo images. Phase 3 = fal Kling b-roll + Seedance 2.0 teaching overlays (@byjoeym method). Spec: `tasks/CONTENT-VISUALS-01-content-kit.md` |
