...
| UX-11 | Design | Mounted-surface UX consistency hardening (no icons/emojis in active Studio surfaces) | Codex | In Review | 0 `lucide-react` in mounted surface scope + build pass | 2026-03-01 | `docs/codex-tasks/UX-CONSISTENCY-AUDIT-2026-03-01.md`, `components/feed-planner/*`, `components/sselfie/maya/*`, `components/academy/*` | Medium | Commit to main and run live smoke |
