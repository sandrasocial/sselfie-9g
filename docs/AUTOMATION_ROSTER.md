...
| `ai-photoshoot-nurture` | 09:30 | AI-prompts + Vault buyer nurture. Free AI Prompts leads stop after the paid Vault/Kit offer sequence. New Prompt Vault, Starter Kit, and AI Photos Kit buyers do not receive a free SUITE trial. Previously issued trial claim links remain valid so existing promises are honored. |
