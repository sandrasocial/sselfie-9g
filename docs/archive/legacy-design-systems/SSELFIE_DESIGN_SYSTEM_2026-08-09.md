# SSELFIE Design System — Superseded 2026-08-09 Version

Status: historical reference only

Superseded by `docs/SSELFIE_DESIGN_SYSTEM.md` on 2026-08-23

Do not use this file as current design guidance.
