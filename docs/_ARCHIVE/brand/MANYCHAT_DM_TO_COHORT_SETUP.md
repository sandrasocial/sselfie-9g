...
6. DM sources (`manychat_dm` / `instagram_dm` / manual quick-add) are force-routed to `fit_call` so no DM lead gets lost on checkout routing.

## Tracked apply link

Use this as your default ManyChat button URL:

`https://sselfie.ai/apply/brand-engine?sourceChannel=manychat_dm&sourceDetail=manychat_day1&utm_source=instagram_dm&utm_medium=manychat&utm_campaign=cohort_day1`

Day-based variants:

- Day 1: `...sourceChannel=manychat_dm&sourceDetail=manychat_day1&utm_campaign=cohort_day1`
- Day 2: `...sourceChannel=manychat_dm&sourceDetail=manychat_day2&utm_campaign=cohort_day2`
- Day 3: `...sourceChannel=manychat_dm&sourceDetail=manychat_day3&utm_campaign=cohort_day3`
- Day 4: `...sourceChannel=manychat_dm&sourceDetail=manychat_day4&utm_campaign=cohort_day4`
- Day 5: `...sourceChannel=manychat_dm&sourceDetail=manychat_day5&utm_campaign=cohort_day5`
- Day 6: `...sourceChannel=manychat_dm&sourceDetail=manychat_day6&utm_campaign=cohort_day6`
- Day 7: `...sourceChannel=manychat_dm&sourceDetail=manychat_day7&utm_campaign=cohort_day7`
