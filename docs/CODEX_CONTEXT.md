...
- **Maya reliability program**: Active as of 2026-03-11. Source of truth: `docs/MAYA_RELIABILITY_PROGRAM_2026-03-11.md`. Locked surface architecture is `Photos`, `Videos`, `Train` as visible Maya top tabs; Feed remains a separate deep editor until re-unified. Do not add new Maya tabs or `chat_type` values without DB, load/save/new-chat, renderer, and test coverage.
